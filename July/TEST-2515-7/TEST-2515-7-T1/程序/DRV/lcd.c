...
void LCD_MainLedSceneInit()
{
    ...
    // 绘制 标题
    LCD_MainLedSceneDrawTitle("KD-2515-7", "测试台", "KD-2515-7", "TEST-2515-7-T1");
    
    LCD_MainDisplaysChineseCharacters(180,120,"频率：",24,LCD_COLOR_BLACK);
    LCD_MainDisplaysChineseCharacters(180,150,"正占：",24,LCD_COLOR_BLACK);
